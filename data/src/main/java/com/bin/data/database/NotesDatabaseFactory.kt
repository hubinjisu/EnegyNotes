...
class NotesDatabaseFactory @Inject constructor(
    ...
    private fun prepopulateTables(db: SupportSQLiteDatabase) {
        ...
        db.execSQL(
            ...
            |(176, '2022-07-27', 'WATER', 1), (182, '2022-08-30', 'WATER', 1), (187, '2022-09-29', 'WATER', 1),
            |(191, '2022-10-28', 'WATER', 1)""".trimMargin()
        )
        ...
        db.execSQL(
            ...
            |(4561, '2022-07-27', 'ELECTRICITY', 1), (4764, '2022-08-30', 'ELECTRICITY', 1), (4935, '2022-09-29', 'ELECTRICITY', 1),
            |(5077, '2022-10-28', 'ELECTRICITY', 1)""".trimMargin()
        )
        ...
        db.execSQL(
            ...
            |(18346, '2022-07-27', 'GAS', 1), (18368, '2022-08-30', 'GAS', 1), (18381, '2022-09-29', 'GAS', 1),
            |(18392, '2022-10-28', 'GAS', 1)""".trimMargin()
        )
    }
}